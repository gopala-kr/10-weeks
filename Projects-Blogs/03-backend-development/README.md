...
There are hundreds of frameworks out there, built to make web development easier. Every year there are releases on new frameworks/improvements over existing ones. Below figure shows how the web frameworks evolved since from dot-com bubble. 
